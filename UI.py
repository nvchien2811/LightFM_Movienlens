...
def Recommender():
    result5.config(text="Hệ thống đang phân tích vui lòng chờ!!!", fg="red", bg='white', font="Time 16 bold")
...
labtexNameNameFilm = Label(labelframeEnter,text="Chọn bộ phim :",fg= "red",bg= 'white' ,font= "Time 10 bold")
labtexNameNameFilm.place(x=5,y=60)
combb1 = CB.Combobox(labelframeEnter, width = 35, height = 9, font = "Time 10 bold",state = "readonly")
combb1['values'] = (DataMovie)
combb1.current(1)
combb1.place(x= 5, y = 80)
# button recommender
btn =Button(labelframeEnter, text = "Gợi ý phim", font = "Time 10 bold", bg = "green", fg = "white", command =Recommender)
btn.place(x= 110, y= 150)
#result recommender
labelframeOutput=LabelFrame(labelframeContent,text="Kết quả hệ thống gợi ý",fg = 'blue',font= "Time 8 bold",width=630,
             height=340,highlightcolor="yellow",bg="white",
